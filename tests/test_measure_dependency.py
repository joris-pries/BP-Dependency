import pytest
import numpy as np
from measure_dependency.dependency import is_Y_constant, bp_dependency, bin_data, unordered_bp_dependency
...
#     assert bp_dependency(Y_indices= Y_indices, X_indices= X_indices, dataset= dataset, binning_indices= binning_indices, binning_strategy= binning_strategy) == -1
...
#     assert unordered_bp_dependency(X_discrete_indices= X_discrete_indices, X_continuous_indices= None, Y_discrete_indices=Y_discrete_indices, Y_continuous_indices= None, local_dataset=local_dataset, kde_strategy= None) == expected
